...
<head>
    ...
    <link rel="stylesheet" href="../contactanos/estilos.css">
...
<body>
    ...
    <div class="container_nc">
        ...
        <div class="pacelldecont"></div>

        <br>
        <h1 class="contxd1" style="margin-top:9%;">Contactos</h1>
        <!--Metodologia-->
        <center>
            <h2 class="button1xd77">Conoce Nuestra Metodología</h2>
        </center>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-headingOne">
                                ...
                                <button class="button collapsed contactoprueba1" type="button" data-bs-toggle="collapse"
                                    ...
                                    <p style="margin-left:40px; margin-top: 10px;"> Asimila <img class="pariconCON" src="../img/ICONOS/flecha.png" alt=""></p><img
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-headingTwo">
                                ...
                                <button class="button collapsed contactoprueba2" type="button" data-bs-toggle="collapse"
                                    ...
                                    <p style="margin-left:40px; margin-top: 10px;"> Aprende <img class="pariconCON" src="../img/ICONOS/flecha.png" alt=""></p><img
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse "
                                ...
                                <div class="accordion-body letrascontactos">Nuestra prioridad es fortalecer el
                                    razonamiento
                                    en
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-headingThree">
                                ...
                                <button class="button collapsed contactoprueba3" type="button" data-bs-toggle="collapse"
                                    ...
                                    <p style="margin-left:40px; margin-top: 10px;"> Aplica <img class="pariconCON" src="../img/ICONOS/flecha.png" alt=""> </p><img
                            ...
                            <div id="flush-collapseThree" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body letrascontactos">Nuestras Tutorias son totalmente
                                    personalizadas
                                    individuales.</div>
                            </div>
                        </div>
        ...
        <!--Cuadros Contactanos-->
        <div class="cuadroscontac">
            <div class="container">
                <div class="row mb-3">
                    <div class="col cardcontac">
                        <br>
                        <div class="card">
                            <img class="xd77" src="../img/ICONOS/llamada-telefonica.png" alt="">
                            <div class="card-body">
                                <h5 class="card-title">Llamanos</h5>
                                <p class="card-text">(02) 5136379</p>
                                <p class="card-text">0992648069</p>
                                <p class="card-text">0995950125</p>
                                <a
                                    href="https://api.whatsapp.com/send?phone=593992648069&app=facebook&entry_point=page_cta"><button
                                        class="button5xd77">Mas Información</button></a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <br>
                        <div class="card">
                            <img class="map77xd" src="img/map (1).png" alt="">
                            <div class="card-body">
                                <h5 class="card-title">Visitanos</h5>
                                <p class="card-text">De los Rosales N46-123 Y
                                <p class="card-text"> Madroños Sector El Inca</p>
                                <p class="card-text">Quito-Ecuador</p>
                                <a
                                    href="https://api.whatsapp.com/send?phone=593992648069&app=facebook&entry_point=page_cta"><button
                                        class="button4xd77">Mas Información</button></a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <br>
                        <div class="card">
                            <img class="mail77xd" src="../img/ICONOS/correos-electronicos.png" alt="">
                            <div class="card-body">
                                <h5 class="card-title">Email</h5>
                                <p class="card-text">info@iecaaa.com</p>
                                <p class="card-text">direcciongeneral@iecaaa.com</p>
                                <p class="card-text">.</p>
                                <a
                                    href="https://api.whatsapp.com/send?phone=593992648069&app=facebook&entry_point=page_cta"><button
                                        class="button3xd77">Mas Información</button></a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <br>
                        <div class="card">
                            <img class="hoursxd" src="img/calendario.png" alt="">
                            <div class="card-body">
                                <h5 class="card-title">Horario de Atención</h5>
                                <p class="card-text">Lunes-Viernes:</p>
                                <p class="card-text">8:00-19:00</p>
                                <p class="card-text">Sabados:8:00-13:00</p>
                                <a
                                    href="https://api.whatsapp.com/send?phone=593992648069&app=facebook&entry_point=page_cta"><button
                                        class="button2xd77">Mas Información</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!--Mapa-->
                <hr><iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.8033826438827!2d-78.47098642778626!3d-0.15678447696428383!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91d5917722c92a35%3A0x620601d318ca8fb!2sInstituto%20de%20Ense%C3%B1anza%20Continua!5e0!3m2!1ses!2sec!4v1663170254875!5m2!1ses!2sec"
                ...
                <div>
                    <p style="color:#1DA1F2; font-size: 30px; text-align: center;">NIVÉLATE, APRENDE Y APRUEBA SIN
                        PROBLEMAS TODAS
                        TUS MATERIAS</p>
                    <p style="color:#1DA1F2; font-size: 20px;text-align: center;">100% PRÁCTICO Y GARANTIZADO, 16 AÑOS
                        DE EXPERIENCIA </p>
                    <h4 style="color:#FF0000; text-align: center;">Contáctenos para una asesoría profesional:</h4>
                    <h4 style=" text-align: center;">0992648069</h4><img class="whats11" src="../img/005-whatsapp.png"
                        alt="..." width="50" height="50">
                </div>
                <!--Final-->
                <br>
                <div class="final2rmrd76">
        <img class="img3xd77" src="../img/HORIZXONTALE GRUPOS DE ESTUDIANTES/ESTUDIANTES-GRUPO-ENVIAR-COMENTARIOS.png"
            alt="">
...
<script src="../encabezado/encabezado.js">
