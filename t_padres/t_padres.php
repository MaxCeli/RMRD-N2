...
<head>
    ...
    <link rel="stylesheet" href="t_padres.css">
...
<body>
    ...
    <div class="pacelldetpa"></div>

    <div class="tit_tesP" style="margin-top: 11%;">
        <h2>Conoce la experiencia de los padres de familia de nuestros estudiantes</h2>
    </div>
    <!-- Metodología -->
    <br>
    <center>
        <div class="metodoUpu" text-center>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body letrasdemeto">Nuestro objetivo es llenar los vacíos
                                académicos generados en años anteriores.</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <center>
        <div class="test_es">Testimonios</div>
    </center>
    <div>
        <center><video controls class="vidtes_1" style="width:70%">
                <source src="../img/videos/testimonios/30-9-2022 ESCUELA.mp4" type="video/mp4">
            </video></center>
        <center><video controls class="vidtes_1" style="width:70%">
                <source src="../img/videos/testimonios/30-9-2022 COLEGIO.mp4" type="video/mp4">
            </video></center>
        <center><video controls class="vidtes_1" style="width:70%">
                <source src="../img/videos/testimonios/30-9-2022 PRE.mp4" type="video/mp4">
            </video></center><br>
        <center><iframe style="margin-left:5px;width:70%; height:100% auto;"
                src="https://www.youtube.com/embed/aLwfQTfAoOE"></iframe></center>
    </div><br>
    <!--Experiencia-->
    <font color="#FF0000">
        <div class="container text-center letras6" style="width: 80%; margin:0 auto;">
            <div class="row ">
    ...
    <center>
        <h4 style=" text-align: center;">0992648069</h4><img class="wats11" src="../preuni/img/wats.jpg" alt="..."
            width="50" height="50">
    </center><br><br>
    </div><br>
