...
<body>
    ...
    <div class="pacelldeblog"></div>


    <br><br>
    <!--Titulo-->
    <center>
        <div class="titblo" style="margin-top: 7%;">Blog</div>
    </center>
    <br>
    <!-- metodología -->
    <center>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingOne">
                            ...
                            <button class="button collapsed pruebademeto1" type="button" data-bs-toggle="collapse"
                                ...
                                <p style="margin-left:40px; margin-top: 10px;"> Asimila <img class="pariconBT" src="../img/ICONOS/flecha.png" alt=""></p><img
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body letrasdemeto3">Nuestro objetivo es llenar los vacíos
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingTwo">
                            ...
                            <button class="button collapsed pruebademeto2" type="button" data-bs-toggle="collapse"
                                ...
                                <p style="margin-left:40px; margin-top: 10px;"> Aprende <img class="pariconBT" src="../img/ICONOS/flecha.png" alt=""> </p><img
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse "
                            ...
                            <div class="accordion-body letrasdemeto3">Nuestra prioridad es fortalecer el razonamiento
                                en
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingThree">
                            ...
                            <button class="button collapsed pruebademeto3" type="button" data-bs-toggle="collapse"
                                ...
                                <p style="margin-left:40px; margin-top: 10px;"> Aplica <img class="pariconBT" src="../img/ICONOS/flecha.png" alt=""> </p><img
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body letrasdemeto3">Nuestras Tutorias son totalmente personalizadas
                                individuales.</div>
                        </div>
                    </div>
                </div>
    ...
    <center>
        <div class="EsloBlog">
            <p>Hola apreciado estudiante, por el momento nos encontramos trabajando el blog, gracias por preferir
                nuestro sistema de aprendizaje y enseñanza continua <font color="#1DA1F2">A</font>simila - <font
                    color="#FF0000">A</font>prende - <font color="#25D366">A</font>plica.</p>
        </div>
    </center>
    <br>
    <!--video-->
    <center><video class="videoblogtemp" autoplay loop controls src="../img/videos2/coming soon.mp4"
            width="800px"></video></center>
    <br>
    <br>
    <!--recuadros rojos-->
    <font color="#FF0000">
    ...
    <div>
        <p style="color:#1DA1F2; font-size: 30px; text-align: center;">NIVÉLATE, APRENDE Y APRUEBA SIN PROBLEMAS TODAS
            TUS MATERIAS</p>
        <p style="color:#1DA1F2; font-size: 20px;text-align: center;">100% PRÁCTICO Y GARANTIZADO, 16 AÑOS DE
            EXPERIENCIA </p>
    ...
    <br>
    <div class="final22">
        <img class="imgblog" src="../img/HORIZXONTALE GRUPOS DE ESTUDIANTES/ESTUDIANTES-GRUPO-ENVIAR-COMENTARIOS.png"
            alt="">
